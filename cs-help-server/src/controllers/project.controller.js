 ...
 */
exports.saveProject = async (project, reteData, custom_blocks = null, block_libs = null) => {
  ...
  // if block libs provided, update that too
  if (block_libs) {
    project.block_libs = block_libs;
    project.markModified("block_libs");
  }
  await project.save();
