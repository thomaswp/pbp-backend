...
const projectSchemas = require("./projects/project.schemas.js");
      ...
      Error: {
        ...
        properties: {
          status: {
            type: "integer",
            description:
              "HTTP Response Status returned along with this response.",
            example: 404,
          },
          message: {
            type: "string",
          ...
          details: {
            description:
              "Any and all details that the server deems useful in analyzing this error.",
